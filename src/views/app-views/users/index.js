      ...
      <div>
        ...
        <form action="#" className="mt-6 flex">
          ...
          <input
            ...
            name="email"
            id="email"
            className="p-2 shadow-sm block w-full sm:text-sm border-gray-300 rounded-md ocus:outline-none focus:ring-0"
            placeholder="Enter an email"
          />
          <button
            type="submit"
            className="ml-4 flex-shrink-0 px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white dark-green-bg hover-light-green-bg focus:outline-none focus:ring-0"
          >
            Send invite
          </button>
        </form>
          ...
          {people.map((person, personIdx) => (
            ...
            >
              ...
              <div className="flex-shrink-0">
                <button
                  type="button"
                  className="inline-flex items-center py-2 px-3 border border-transparent rounded-full bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-0"
                >
                  <PlusSmIcon
